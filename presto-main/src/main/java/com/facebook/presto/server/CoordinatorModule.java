        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, CreateTableWithFiber.class, CreateTableWithFiberTask.class);
        bindDataDefinitionTask(binder, executionBinder, LoadWithDelimited.class, LoadWithDelimitedTask.class);
